            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <div className="w-9 h-9 rounded-full p-[2px] bg-gradient-to-tr from-brand via-rose-500 to-purple-600 shadow-[0_0_10px_rgba(255,40,78,0.3)] group-hover:shadow-[0_0_20px_rgba(255,40,78,0.6)] transition-all shrink-0">
                  {user.photoURL ? (
                    <img src={user.photoURL} alt="Profile" className="w-full h-full rounded-full object-cover border border-[#0a0a0a]" referrerPolicy="no-referrer" />
                  ) : (
          ...
          >
            {user && (
              <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                {user.photoURL ? (
                  <img src={user.photoURL} alt="Profile" className="w-10 h-10 rounded-full border border-white/20 object-cover" referrerPolicy="no-referrer" />
                ) : (
