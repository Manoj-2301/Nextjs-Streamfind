...
export async function POST(request: Request) {
  try {
    ...
    await transporter.sendMail({
      ...
      html: generateExportEmailHtml(name),
      attachments: [
        {
...
function generateExportEmailHtml(name: string) {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <tr>
            <td style="padding:20px 24px;">
              ...
              <p style="margin:0;font-size:13px;line-height:1.7;color:rgba(255,255,255,0.6);">
                Your StreamFind data export is ready. We've attached a complete JSON archive of your account including your profile, watchlist, reviews, and recent account activity.
              </p>
            </td>
          </tr>
        </table>
          ...
          <tr>
            <td style="text-align:center;padding:16px 0;">
              ...
              <p style="margin:0 auto;font-size:12px;color:rgba(255,255,255,0.45);line-height:1.7;max-width:360px;">
                The attached <strong style="color:rgba(255,255,255,0.65);">.json</strong> file contains your complete StreamFind data. Keep it in a safe place.
              </p>
            </td>
          </tr>
        </table>
